...
import { WorkbenchCompatibilityHandoffPage, WorkbenchRunDayRetiredPage } from '../pages/workbench/WorkbenchRetiredRoutePage';
...
export const rosteringWorkbenchRoutes: AppRoute[] = [
  ...
  route('rostering-workbench', '/rostering-workbench/draft-versions', 'workbench-draft-versions', compatibilityHandoffPage),
  route('rostering-workbench', '/rostering-workbench/run-day-adjustments', 'workbench-run-day-adjustments', runDayRetiredPage),
  route('rostering-workbench', '/rostering-workbench/archive-entry', 'workbench-archive-entry', compatibilityHandoffPage),
];
